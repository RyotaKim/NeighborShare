...
/// App text styles using Material Design 3 typography
...
class AppTextStyles {
  ...
  // Item card title (2 lines, ellipsis)
  static const TextStyle itemCardTitle = TextStyle(
    fontFamily: fontFamily,
    fontSize: 14,
    fontWeight: FontWeight.w500,
    letterSpacing: 0.1,
  ...
  // Item card subtitle (username)
  static const TextStyle itemCardSubtitle = TextStyle(
    fontFamily: fontFamily,
    fontSize: 12,
    fontWeight: FontWeight.w400,
    letterSpacing: 0.4,
  ...
  // Create TextTheme for Material app
